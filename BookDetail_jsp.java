...
//Database connection string
  ...
  String getParam(javax.servlet.http.HttpServletRequest req, String paramName) {
    ...
    param = myCustomSanitizeRoutine(param);
    if ( param == null || param.equals("") ) return "";
    return param;
  }

  String myCustomSanitizeRoutine(String value)
  {
    // Do your sanitization here
    // This method does nothing deliberatly
    // as it is here for demo purposes only
    return value;
  }
